...
NOTE: We are assuming that you can build and delpoy a native app already _(if not, you can read our previous article on link:https://fw4spl-org.github.io/fw4spl-blog/2015/04/13/Fw4spl-and-Android.html[FW4SPL and Android])_.
